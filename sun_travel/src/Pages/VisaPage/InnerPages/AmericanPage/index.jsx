...
import { americanCountriesData } from "../../../VisaPage/SearchableDropDown/countrylistdata";
...
function AmericanPage() {
  ...
  console.log(americanCountriesData, "CombainedAustraliaInner");
  ...
  return (
    <Wrapper id="detailMainWrapper">
      {americanCountriesData.map((data, index) => {
